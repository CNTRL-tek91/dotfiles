...
validate_image_directory
# Only pick regular image files (skip subdirectories like Dynamic-Wallpapers).
shopt -s nullglob nocaseglob
images=("$IMAGE_DIR"/*.png "$IMAGE_DIR"/*.jpg "$IMAGE_DIR"/*.jpeg "$IMAGE_DIR"/*.webp "$IMAGE_DIR"/*.gif "$IMAGE_DIR"/*.bmp)
